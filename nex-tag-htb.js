...
var PartnerSpecificValidator = require('nex-tag-htb-validator.js');
...
function NexTagHtb(configs) {
    ...
    */
    ...
    (function __constructor() {
        ...
        __profile = {
            partnerId: 'NexTagHtb', // PartnerName
            namespace: 'NexTagHtb', // Should be same as partnerName
            statsId: 'NEXT', // Unique partner identifier
            version: '2.0.0',
            targetingType: 'slot',
            enabledAnalytics: {
                requestTime: true
